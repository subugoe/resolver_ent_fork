...
/**
 * This class reads the preference file and parses its XML-structure. The preference
 * file contains all the LPIRs (LocalPersisitentIdentifierResolver) with their name and URL.
 * 
...
public class Preferences {
	...
	/**
	 * The constructor need the filename; the preferences are read from this file using the private read method.
	 * @param filename
	 */
	...
	/**
	 * get value of <debug> element; this value set's the log level for debugging purposes.
	 ...
	 * @param inNode
	 * @return a LocalResolver instanciated from the information in the preferences file.
	 */
	...
	/**
	   * Searches for the value of an XML-element. The value of an element is stored in a text node, which is
	   * the child of an element node. So we are looking for any direct childnodes and check, if these nodes a textnodes.
	   * @param  inNode
	   * @return String or null, if node has no text-node with contents as a child node.
	   *
	   */
