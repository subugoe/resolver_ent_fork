...
/**
 * Servlet receives a URL with an identifier and asks different local
 * identifier resolving systems connected to indiviual document management systems
 * if they have a document with this identifier. Communication is done using simple HTTP requests
 * with an XML-based replay.<p/>
 * If only one answer is received, the origin request is redirected; otherwise a HTML output is generated
 * for the user to chose the appropriate target.
 * <p/>
...
public class Resolver extends HttpServlet {
	...
	/**
	 * Handles the post request; from here onle the method <pre>doGet</pre> is called.
	 */
    @Override
	...
	/**
	 * Writes a log-message to the logfile; the location of th elogfile is set in the 
	 * preference file.
	 * @param inMessage
	 */
	...
	/**
	 * Method initializes the servlet: loads preferences (from resolver_config.xml within the 
	 * application's webapp-folder).
	 * 
	 */
    @Override
	public void init(){
